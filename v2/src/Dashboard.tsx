    ...
    <div className="db-root">
      <div className="db-hero">
        ...
        <div>
          ...
          <p className="db-subtitle">Pick up where you left off <span style={{ fontSize: '0.65rem', opacity: 0.45, marginLeft: '6px', fontFamily: 'monospace', letterSpacing: '0.5px' }}>v2026.06.10-20:15</span></p>
        </div>
      </div>

...
const SOURCE_PREFIX = "ep/b-think1-u12/";
...
async function main() {
    console.log(`Starting to move files from "${SOURCE_PREFIX}" to "${DEST_PREFIX}" in batches of 20...`);
    ...
    console.log(`\n🎉 Done! All files moved successfully in batches of 20.`);
}

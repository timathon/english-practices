...
3. Passage & Mapping Integrity:
   - **Passage Integrity:** You MUST include the **entire full passage/article/dialogue** verbatim (every single sentence, inline parenthetical Chinese annotations like "(洞)" or "(装订)", name prefix, signature, etc.) exactly as it appears in the source markdown. Do NOT summarize, omit, remove, clean up, or truncate any paragraphs, sentences, inline parenthetical Chinese annotations, headers, list items, quotes, or signatures (e.g. keep "Make a hole (洞) at the top of the plate.", "--Jenny", "--Lisa", etc.).
